 ...
 * </p>
 * <ul>
 *   <li>{@link vis4bridge.impl.VisualizationImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class VisualizationImpl extends MinimalEObjectImpl.Container implements Visualization {
	...
	protected EClass eStaticClass() {
		return Vis4bridgePackage.Literals.VISUALIZATION;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, Vis4bridgePackage.VISUALIZATION__NAME, oldName,
					name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case Vis4bridgePackage.VISUALIZATION__NAME:
			return getName();
		}
